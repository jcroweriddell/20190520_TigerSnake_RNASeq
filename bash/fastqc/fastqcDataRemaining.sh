...
#SBATCH -o /fast/users/a1662801/20190520_TigerSnake_RNASeq/slurm/fastqcData_%j.out
#SBATCH -e /fast/users/a1662801/20190520_TigerSnake_RNASeq/slurm/fastqcData_%j.err
...
fastqc -o ${OUTDIR}/ \
  ${DATADIR}/MV1_MAINLAND.trimmed2.fq.gz \
  ${DATADIR}/MV2_MAINLAND.trimmed1.fq.gz \
  ${DATADIR}/MV2_MAINLAND.trimmed2.fq.gz \
  ${DATADIR}/R14_REEVESBYISLAND.trimmed1.fq.gz \
  ${DATADIR}/R14_REEVESBYISLAND.trimmed2.fq.gz
